...
public class AdministradorService {
    ...
    public Administrador atualizar(UUID id, AdministradorForm administradorForm){
        Administrador administrador = administradorForm.atualizar(this.getAdministradorById(id));
        this.administradorRep.save(administrador);
        return administrador;
    }

    //Deleta administrador
    public void deletar(UUID id) { this.administradorRep.deleteById(id); }
